...
results in maximum amplitude of $\displaystyle \max_{-1\leq x\leq 1}|\pi_{n+1}(x)| = \frac{1}{2^n}$.
...
\begin{liste}
  ...
  \item[-] Practicality: Measurements are often only uniformly possible (limited edge resolution)
